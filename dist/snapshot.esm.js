...
function processValues(values, options) {
    ...
    var weightDecimals = BigNumber.from(10).pow(BigNumber.from(options.weightDecimals || 0));
    var result;
    if (options.uniPairAddress == null) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch$1(apiUrl + "/api.AccountService.GetIotexBalanceByHeight", {
                            method: 'POST',
                            headers: {
                                Accept: 'application/json',
                                'Content-Type': 'application/json'
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch$1(apiUrl + "/api.AccountService.GetErc20TokenBalanceByHeight", {
                            method: 'POST',
                            headers: {
                                Accept: 'application/json',
                                'Content-Type': 'application/json'
            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [2 /*return*/, Object.fromEntries(balanceResp.map(function (value, i) { return [
                            addresses[i],
                            parseFloat(formatUnits(value[0].mul(exchangeRate).div(ONE_E18$1).toString(), options.decimals))
                        ]; }))];
            }
        });
    });
                    ...
                    return [2 /*return*/, Object.fromEntries(addresses.map(function (address) { return [
                            ...
                            parseFloat(formatUnits(result.boo[address]
                                ...
                                options.vaultTokens.reduce(function (prev, token, idx) {
                                    return prev +
                                        parseFloat(formatUnits(result.vaultTokens[address][token.address]
            ...
            switch (_c.label) {
                ...
                case 6:
                    ...
                    return [2 /*return*/, Object.entries(aggregatedDelegations).reduce(function (transformed, _a, _) {
                            ...
                            transformed[delegatorAddress] = parseFloat(formatUnits(delegatedStake.toString(), 18));
                            return transformed;
                        }, {})];
            }
        });
...
var retrieveInfoFromOracle = function (provider, network, oracleAddress, questionId) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                result = _a.sent();
                currentBond = formatEther(BigNumber$1.from(result[1][0]));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        currentBond = _a.sent();
                        minimumBondIsZero = BigNumber$1.from(minimumBondInDaoModule).eq(0);
                        minimumBond = minimumBondIsZero
                            ? 1000000000000000
                            : minimumBondInDaoModule;
                        bond = currentBond.eq(BigNumber$1.from(0))
                            ? BigNumber$1.from(minimumBond)
                            : currentBond.mul(2);

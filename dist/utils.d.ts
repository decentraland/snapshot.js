...
export declare function getScores(space: string, strategies: any[], network: string, provider: any, addresses: string[], snapshot?: number | string): Promise<any[]>;
export declare function validateSchema(schema: any, data: any): true | import("ajv").ErrorObject<string, Record<string, any>>[] | null | undefined;
